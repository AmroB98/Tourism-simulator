...
class Residence extends AttractionFactor{
	//fields
	Scanner input = new Scanner(System.in);
	//private double touring= 0;
	...
	// constructors
	Residence(){ 					}
	Residence(String Activity){		set(Activity); }
	Residence(int initialHex) {		setAllHex(initialHex); }
	// set methods
	...
	public String		Type(){		return ActivityType.Residence.toString();}
